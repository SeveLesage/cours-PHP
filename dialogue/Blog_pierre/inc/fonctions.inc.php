...
//je cree ma function pour verifier que l'utilisateur est connecté
    ...
    function estConnecte () {
        if (isset($_SESSION['menbres'])) {//si dans la superglobale $_SESSIONS je recupere un indice memebre, cela signifie que la personne est connecte
...
//Je verifie que le membre qui est connecte est admin
    ...
    function estAdmin () {
        if (estConnecte() && $_SESSION['menbres']['statut'] == 1) { // si l'utilisateur est connecte et que son  statut est 1 alors il est admin
