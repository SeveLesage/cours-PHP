...
if (isset($_GET['action']) && $_GET['action'] == 'suppression' && isset($_GET['id_employes'])) {
    ...
    if ($resultat->rowCount() == 0) {
        $contenu .= '<div class="alert alert-danger">Erreur de suppression de l\'employé n° ' . $_GET['id_employes'] . ' </div>';/* .=(concatener et ajouter) si ça n'a pas fonctionné j'affiche ça */
    } else {
